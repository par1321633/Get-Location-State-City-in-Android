...
public class GPSTracker extends Service implements LocationListener {
    ...
    private Location getLocation() {
        ...
        Toast.makeText(mContext, "GPS= " + isGPSEnabled + " isNetwork = " + isNetworkEnabled, Toast.LENGTH_SHORT).show();
        ...
        if (!isGPSEnabled && !isNetworkEnabled) {
            ...
            if (isNetworkEnabled) {
                ...
                locationManager.requestLocationUpdates(
                    ...
                    Log.d("shittt", "Network");
                    if (locationManager != null) {
                        Log.d("shittt", "Test locatonManager");
                        location = locationManager
                                .getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
                        if (location != null) {
                            Log.d("shittt", "test location");
                ...
                if (isGPSEnabled) {
                    Log.d("shittt", "Test GPS");
                    if (location == null) {
                        locationManager.requestLocationUpdates(
                                LocationManager.GPS_PROVIDER,
                                MIN_TIME_BW_UPDATES,
                                MIN_DISTANCE_CHANGE_FOR_UPDATES, (LocationListener) this);
                        Log.d("shittt", "GPS Enabled");
                        if (locationManager != null) {
                            location = locationManager
